describe('Grid', function () {
    ...
    describe('Winner', function () {
        ...
        it('should return winner if the third row is the same player', function () {
            grid.setCell(6, p1);
            expect(grid.winner()).toEqual(null);
            grid.setCell(3, p2);
            grid.setCell(7, p1);
        ...
        it('should return winner if the first column is the same player', function () {
            grid.setCell(0, p1);
            expect(grid.winner()).toEqual(null);
            grid.setCell(1, p2);
            grid.setCell(3, p1);
        ...
        it('should return winner if the third column is the same player', function () {
            grid.setCell(2, p1);
            expect(grid.winner()).toEqual(null);
            grid.setCell(1, p2);
            grid.setCell(5, p1);
